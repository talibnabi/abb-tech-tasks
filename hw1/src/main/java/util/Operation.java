...
public class Operation {
    ...
    public static final String[][] event = {{"1929", "When did the Economic Depression begin?"},
    ...
    public static int inputChecker(String gameType) {
        switch (gameType) {
            case "number":
        ...
        String guess = Operation.scanner.next();
        int guessNumber = 0;
        ...
        if (convertableType) {
            ...
            if (gameType.equals("number")) {
                return inputChecker("number");
            } else {
                return inputChecker("event");
            }
